...
public class SwaggerConfig {
    ...
    private final Contact DEFAULT_CONTACT = new Contact("Maik","maik.com","nojodasmas@hotmail.com");
    private final ApiInfo DEFAULT_API_INFO = new ApiInfo("Api Documentation", "Api Documentation", "1.0", "urn:tos", DEFAULT_CONTACT, "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0", new ArrayList());
